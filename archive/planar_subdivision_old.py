...
def detect_crossed_folds(
    ...
    for fold in fold_markers:
        ...
        # Crossing happens when classification changes from BEFORE to something else
        if class_from == "BEFORE" and class_to != "BEFORE":
            crossed.append((fold, class_to))
        # Also handle crossing from IN_ZONE to AFTER
        elif class_from == "IN_ZONE" and class_to == "AFTER":
            # Update classification from IN_ZONE to AFTER
